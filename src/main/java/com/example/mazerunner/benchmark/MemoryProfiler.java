...
public class MemoryProfiler implements InternalProfiler {
    ...
    public Collection<? extends Result> afterIteration(final BenchmarkParams benchmarkParams, final IterationParams iterationParams,
        ...
        final long usedMemoryAfterIteration = getUsedMemory();
        references = null;

        final long usedMemoryInIteration = usedMemoryAfterIteration - usedMemoryBeforeIteration;
        final double usedMemoryPerOp = ((double) usedMemoryInIteration) / result.getMetadata().getMeasuredOps();
    ...
    private static long getUsedMemory() {
        ...
        final List<GarbageCollectorMXBean> gcBeans = new ArrayList<GarbageCollectorMXBean>();
        ...
        final long startGcCount = countGc(gcBeans);
